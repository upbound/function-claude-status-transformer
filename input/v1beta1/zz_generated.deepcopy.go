...
func (in *AWSBedrock) DeepCopyInto(out *AWSBedrock) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSBedrock.
func (in *AWSBedrock) DeepCopy() *AWSBedrock {
	if in == nil {
		return nil
	}
	out := new(AWSBedrock)
